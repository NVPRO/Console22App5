...
// Здесь требуется использовать класс Dictionary.
{
    ...
    /// <summary>Статический класс Message</summary>
        static class Message
        {
            ...
            static Message()
            {
                text = "Ночью был шторм. Дул сильный ветер. К утру шторм стих. Наташа и Серёжа пошли к морю. " +
                    "Наташа подняла с песка маленького рачка. Волны его выбросили на берег. Он слабо шевелил лапками. " +
                    "Девочка бросила рачка в воду. Он закувыркался в зелёной воде и уплыл. В луже на боку плавала рыбка. " +
                    "Серёжа поймал её и выпустил в море. В этот день дети спасли много морских зверьков. " +
                    "Повторим несколько слов для частотного анализа: шторм, пошли, воде, рыбка, воде, много, ";
            }
